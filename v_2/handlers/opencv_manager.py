...
class OpencvManager:
    ...
    def prepare_matrix_to_colour(self, matrix_to_save: np.array) -> np.array:
        image_blank = np.zeros((matrix_to_save.shape[0], matrix_to_save.shape[1], 3), np.uint8)
    ...
    def try_to_transporant(self):
        src = cv2.imread('/home/wasabi/Desktop/UAF/PolivProcessing/Poliv/v_2/output_new_colour.png', 1)
        ...
        cv2.imwrite("try_to_transport.png", dst)

    def open_small_map(slef):
        src = cv2.imread('/home/wasabi/Desktop/UAF/PolivProcessing/Poliv/v_2/small_map.png', 1)
        print(type(src))
    ...
    def colour_image_matrix(self, matrix_to_save: np.array, norm_coeff_80):
        ...
        cv2.imwrite("output.png", matrix_to_save)
        cv2.imwrite("output_new_colour.png", ans)
